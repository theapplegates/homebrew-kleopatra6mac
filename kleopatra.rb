class Kleopatra < Formula
  ...
  depends_on "kf6-iso-codes"
  depends_on "kf6-archive"
  depends_on "kf6-codecs"
  depends_on "kf6-config"
  depends_on "kf6-configwidgets"
  depends_on "kf6-coreaddons"
  depends_on "kf6-crash"
  depends_on "kf6-dbusaddons"
  depends_on "kf6-i18n"
  depends_on "kf6-iconthemes"
  depends_on "kf6-io"
  depends_on "kf6-itemmodels"
  depends_on "kf6-mime"
  depends_on "notifications"
  depends_on "statusnotifieritem"
  depends_on "widgetsaddons"
