class Kleopatra < Formula
  ...
  depends_on "kde/kde/kf6-kcoreaddons"
  depends_on "kde/kde/kf6-kiconthemes"
  depends_on "kde/kde/kf6-kio"
  depends_on "kde/kde/kf6-kitemviews"
  depends_on "kde/kde/kf6-kjobwidgets"
  depends_on "kde/kde/kf6-knotifications"
  depends_on "kde/kde/kf6-kservice"
  depends_on "kde/kde/kf6-kstatusnotifieritem"
  depends_on "kde/kde/kf6-ktextwidgets"
  depends_on "kde/kde/kf6-kwidgetsaddons"
  depends_on "kde/kde/kf6-kxmlgui"
  depends_on "kde/kde/kf6-kcmutils"
  depends_on "kde/kde/kf6-kcontacts"

  # PIM and crypto dependencies
  depends_on "gpgme"
  depends_on "kde/kde/kf6-gpgme"
